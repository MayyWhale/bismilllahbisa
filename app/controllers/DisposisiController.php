...
class DisposisiController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		$db->join("sifat_surat", "disposisi.sifat_surat = sifat_surat.id_sifat", "INNER");
	...
	function add($formdata = null){
		...
		$page_title = $this->view->page_title = "Tambah Disposisi";
	...
	function edit($rec_id = null, $formdata = null){
		...
		if($formdata){
			...
			if($this->validated()){
				...
				if($bool && $numRows){
					$this->set_flash_msg("Disposisi Berhasil Diupdate", "success");
					return $this->redirect("disposisi");
				}
				else{
					if($db->getLastError()){
	...
	function delete($rec_id = null){
		...
		if($bool){
			$this->set_flash_msg("Disposisi Berhasil Dihapus", "success");
		}
