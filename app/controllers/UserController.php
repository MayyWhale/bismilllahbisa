...
class UserController extends SecureController{
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("username","password","user_role_id","nama_pengguna");
			...
			if($this->validated()){
				...
				if($rec_id){
					$this->set_flash_msg("Pengguna Berhasil Ditambahkan", "success");
		...
		$page_title = $this->view->page_title = "Tambah Data Pengguna";
	...
	function edit($rec_id = null, $formdata = null){
		...
		if($formdata){
			...
			if($this->validated()){
				...
				if($bool && $numRows){
					$this->set_flash_msg("Pengguna Berhasil Diupdate", "success");
					return $this->redirect("user");
				}
				else{
					if($db->getLastError()){
	...
	function delete($rec_id = null){
		...
		if($bool){
			$this->set_flash_msg("Pengguna Berhasil Dihapus", "success");
		}
