...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Tambah Laporan</h4>
                </div>
            </div>
        </div>
    </div>
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <select required=""  id="ctrl-no_surat" name="no_surat"  placeholder="Select a value ..."    class="custom-select" >
                                                    ...
                                                    $selected = $this->set_field_selected('no_surat',$value, "");
                                                    ?>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="input-group">
                                                    <input id="ctrl-jam" class="form-control datepicker  datepicker"  value="<?php  echo $this->set_field_value('jam',""); ?>" type="time" name="jam" placeholder="Enter Jam" data-enable-time="true" data-min-date="" data-max-date=""  data-alt-format="H:i" data-date-format="H:i:S" data-inline="false" data-no-calendar="true" data-mode="single" /> 
                                                        <div class="input-group-append">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <textarea placeholder="Enter Tempat Pelaksanaan" id="ctrl-tempat_pelaksanaan"  rows="5" name="tempat_pelaksanaan" class=" form-control"><?php  echo $this->set_field_value('tempat_pelaksanaan',""); ?></textarea>
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <textarea placeholder="Enter Kegiatan" id="ctrl-kegiatan"  rows="5" name="kegiatan" class=" form-control"><?php  echo $this->set_field_value('kegiatan',""); ?></textarea>
                                                        <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
                                                    </div>
                                                </div>
                                            </div>
