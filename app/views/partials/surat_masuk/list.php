                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <?php } ?>
                                                <th class="td-sno">#</th>
                                                <th  class="td-nomor_surat"> No Surat</th>
                                                <th  class="td-tanggal_surat"> Tgl Surat</th>
                                                <th  class="td-asal_surat"> Instansi Pengirim</th>
                                                <th  class="td-perihal_surat"> Perihal</th>
                                                <th  class="td-klasifikasi_surat"> Klasifikasi</th>
                                                <th  class="td-file_surat"> File</th>
                                                <th  class="td-diterima_oleh"> Penerima</th>
                                                <th  class="td-nomor_agenda"> No Agenda</th>
                                                <th class="td-btn"></th>
                                            </tr>
                                        </thead>
                                        <?php
                                                ...
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-asal_surat">
                                                        <span <?php if($can_edit){ ?> data-value="<?php echo $data['asal_surat']; ?>" 
                                                            ...
                                                            data-title="Enter Instansi Pengirim" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="text" 
                                                            data-mode="popover" 
                                                    ...
                                                    <td class="td-perihal_surat"><a href="<?php print_link("surat_masuk/view/$data[id_surat]") ?>"><?php echo $data['perihal_surat']; ?></a></td>
                                                    <td class="td-klasifikasi_surat">
                                                        <span <?php if($can_edit){ ?> data-value="<?php echo $data['klasifikasi_surat']; ?>" 
                                                            data-pk="<?php echo $data['id_surat'] ?>" 
                                                            data-url="<?php print_link("surat_masuk/editfield/" . urlencode($data['id_surat'])); ?>" 
                                                            data-name="klasifikasi_surat" 
                                                    ...
                                                    <td class="td-nomor_agenda">
                                                        <span <?php if($can_edit){ ?> data-value="<?php echo $data['nomor_agenda']; ?>" 
                                                            data-pk="<?php echo $data['id_surat'] ?>" 
                                                            data-url="<?php print_link("surat_masuk/editfield/" . urlencode($data['id_surat'])); ?>" 
                                                            data-name="nomor_agenda" 
                                                            data-title="Enter Nomor Agenda" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="text" 
                                                            data-mode="popover" 
                                                    ...
                                                    <th class="td-btn">
                                                        ...
                                                        <?php } ?>
                                                        <?php if($can_delete){ ?>
                                                        <a class="btn btn-sm btn-danger has-tooltip record-delete-btn" title="Delete this record" href="<?php print_link("surat_masuk/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Apakah Anda yakin ingin menghapus data ini ?" data-display-style="modal">
