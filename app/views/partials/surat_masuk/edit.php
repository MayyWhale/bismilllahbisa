                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-nomor_agenda"  value="<?php  echo $data['nomor_agenda']; ?>" type="text" placeholder="Enter Nomor Agenda"  name="nomor_agenda"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-asal_surat"  value="<?php  echo $data['asal_surat']; ?>" type="text" placeholder="Enter Instansi Pengirim"  required="" name="asal_surat"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-klasifikasi_surat"  value="<?php  echo $data['klasifikasi_surat']; ?>" type="text" placeholder="Enter Klasifikasi"  required="" name="klasifikasi_surat"  class="form-control " />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <textarea placeholder="Enter Perihal" id="ctrl-perihal_surat"  rows="5" name="perihal_surat" class=" form-control"><?php  echo $data['perihal_surat']; ?></textarea>
