...
$can_add = ACL::is_allowed("disposisi_masuk/add");
$can_edit = ACL::is_allowed("disposisi_masuk/edit");
$can_view = ACL::is_allowed("disposisi_masuk/view");
$can_delete = ACL::is_allowed("disposisi_masuk/delete");
?>
<?php
...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Disposisi Masuk</h4>
                </div>
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('disposisi_masuk'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('disposisi_masuk'); ?>">
                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="disposisi_masuk-list-records">
                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-id_user"> Penerima</th>
                                            </tr>
                                        </thead>
                                        <?php
                                        if(!empty($records)){
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-catatan"> <?php echo $data['catatan']; ?></td>
                                                <td class="td-id_user">
