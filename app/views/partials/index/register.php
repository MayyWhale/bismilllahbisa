                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-nama_pengguna"  value="<?php  echo $this->set_field_value('nama_pengguna',""); ?>" type="text" placeholder="Enter Nama Pengguna"  required="" name="nama_pengguna"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
