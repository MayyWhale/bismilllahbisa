                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-username"  value="<?php  echo $data['username']; ?>" type="text" placeholder="Masukkan Nama Pengguna"  required="" name="username"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="input-group">
                                                    <input id="ctrl-password"  value="<?php  echo $data['password']; ?>" type="password" placeholder="Enter Password" maxlength="255"  name="password"  class="form-control  password password-strength" />
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-nama_pengguna"  value="<?php  echo $data['nama_pengguna']; ?>" type="text" placeholder="Masukkan Nama Lengkap"  required="" name="nama_pengguna"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-email"  value="<?php  echo $data['email']; ?>" type="email" placeholder="Masukkan Email"  name="email"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-telepon"  value="<?php  echo $data['telepon']; ?>" type="text" placeholder="Masukkan Telepon"  name="telepon"  class="form-control " />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
